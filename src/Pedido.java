...
public class Pedido implements Comparable<Pedido> {
	 ...
	 * armazenar a data, o código identificador e a forma de pagamento informados
	 * para o pedido.
	 */
	 ...
	 * @return true/false indicando se a inclusão do produto no pedido foi realizada
	 *         com sucesso.
	 */
	 ...
	 * Contém um cabeçalho com seu código identificador, sua data e o número de
	 * produtos no pedido.
	 * Depois, em cada linha, a descrição de cada produto do pedido.
	 * Ao final, mostra a forma de pagamento, o percentual de desconto (se for o
	 * caso) e o valor a ser pago pelo pedido.
	 * Exemplo:
	 * Número do pedido: 01
	 ...
	 * Retorna um valor negativo se este pedido tiver um identificador anterior ao
	 * do outro pedido,
	 * valor positivo se o identificador for posterior ao do outro pedido. Para o
	 * mesmo pedido, o
	 * retorno é 0.
	 * 
